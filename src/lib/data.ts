...
const clientData: { [key: string]: { siteCode: string } } = {
  "ACCI LEVEL 6": { siteCode: "UOC117" },
  "ANNE MCLAREN": { siteCode: "UOC1" },
  "BARTON HOUSE": { siteCode: "UOC119" },
  "BAY 13": { siteCode: "UOC5" },
  "BIO-RESIPISHORY LAB LEVEL 1": { siteCode: "UOC3" },
  "BONE RESEARCH/RADIOLOGY LEVEL 4": { siteCode: "UOC122" },
  "CEDAR": { siteCode: "UOC3" },
  "CLIFFORD ALLBUTT BUILDING - CAB": { siteCode: "UOC4" },
  "CLINICAL SCHOOLS": { siteCode: "UOC6" },
  "COTON HOUSE": { siteCode: "UOC120" },
  "E7": { siteCode: "" },
  "EAST FORVIE (IPH - INSTITUTE OF PUBLIC HELATH)": { siteCode: "UOC9" },
  "GRANTCHESTER HOUSE": { siteCode: "UOC104" },
  "HERSCHEL SMITH BUILDING - HSB": { siteCode: "UOC8" },
  "HLRI - HEART & LUNG BUILDING / VICTOR PHILLIP DAHDAL": { siteCode: "UOC15" },
  "IMS LEVELS 4&5": { siteCode: "UOC105" },
  "ISLAND RESEARCH BUILDING - IRB": { siteCode: "UOC10" },
  "JEFFREY CHEAH (CAPELLA) OFFICE": { siteCode: "UOC11" },
  "JOHN VAN GEEST - JVG": { siteCode: "UOC12" },
  "MEDICINE LEVEL 5": { siteCode: "UOC108" },
  "MEDICAL GENETICS LEVEL 6": { siteCode: "UOC107" },
  "MRC EPIDEMIOLOGY LEVEL 3": { siteCode: "UOC109" },
  "MRC WATERBEACH SAMPLE STORAGE": { siteCode: "UOC118" },
  "NEURO SPACE": { siteCode: "UOC126" },
  "OBS": { siteCode: "UOC110" },
  "OLD IMS - LAB BLOCK 4": { siteCode: "UOC106" },
  "P&A - PSYCHIATRY & ANAESTHETICS LEVEL 4": { siteCode: "UOC111" },
  "PAEDIATRICS LEVEL 8": { siteCode: "UOC123" },
  "POST DOC": { siteCode: "?" },
  "STRAGEWAYS (SLR)": { siteCode: "UOC14" },
  "SURGERY & RHEUMATOLOGY LEVEL 6 HUB": { siteCode: "UOC124" },
  "SURGERY LEVEL 9": { siteCode: "UOC121" },
  "TMS F&G LEVEL 2 OFFICE SPACE": { siteCode: "UOC3" },
  "WBIC RPU BASEMENT": { siteCode: "UOC125" },
  "WEST FORVIE": { siteCode: "UOC16" },
  "WOLFSON BRAIN MAIN WBIC & ANNEX ON CORNER": { siteCode: "UOC112" },
  "X RAY BLOCK RADIOLOGY LEVEL 5": { siteCode: "UOC113" },
};
